...
# scene_info = SceneInfo(#point_cloud=pcd, # 点云对象
#                         train_cameras=train_cam_infos, # 训练相机列表
#                         test_cameras=test_cam_infos, # 测试相机列表
                        # nerf_normalization=nerf_normalization, # NeRF++ 归一化参数
